...
def render(api: APIClient) -> None:
    render_page_header(
        ...
        "Sign in to explore a polished paper-trading demo: read probabilities, build a portfolio, and follow your positions without the friction of a full trading stack.",
        eyebrow="Welcome",
    ...
    if st.session_state.get("is_authenticated"):
        st.markdown(
            ...
            <section class="hero-panel">
              ...
              <h2>Welcome back</h2>
              <p>You are signed in as {st.session_state.get('user_email')}. Use the navigation on the left to move from market discovery to portfolio tracking.</p>
            </section>
            """,
    ...
    with left:
        st.markdown(
            ...
            <section class="hero-panel">
              ...
              <p>This interface is built for a curious audience: simple enough for a first encounter with prediction markets, structured enough to feel like a real product demo.</p>
              <div class="hero-panel__list">
                ...
                <div class="hero-panel__item">
                  ...
                  <p>Place simulated BUY and SELL orders before worrying about execution complexity.</p>
                </div>
                <div class="hero-panel__item">
        ...
        st.markdown(
            ...
            <div class="feature-grid">
              <div class="feature-card">
                <h4>Discovery</h4>
                <p>Scan live-looking market snapshots and focus on the latest probability signal.</p>
              </div>
              <div class="feature-card">
                <h4>Simulation</h4>
                <p>Experiment with position sizing and outcome selection using a low-friction ticket.</p>
              </div>
              <div class="feature-card">
                <h4>Teaching value</h4>
                <p>Every screen includes short hints so non-specialists can understand the mechanics fast.</p>
              </div>
            </div>
            """,
            unsafe_allow_html=True,
    ...
    with right:
        ...
        st.caption("This login flow is intentionally lightweight and designed for product demonstration.")
